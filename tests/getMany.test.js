...
describe('between filter', () => {
	...
	async function verify(dbName) {
		const { db } = getDb(dbName);
		const rows = await db.customer.getMany({
			where: x => x.balance.between(178, 200),
			orderBy: 'id'
		});
...
describe('between filter with column bound', () => {
	test('pg', async () => await verify('pg'));
	test('pglite', async () => await verify('pglite'));
	test('oracle', async () => await verify('oracle'));
	test('mssql', async () => await verify('mssql'));
...
describe('getMany many-relation count filter', () => {
	test('pg', async () => await verify('pg'));
	test('pglite', async () => await verify('pglite'));
	test('oracle', async () => await verify('oracle'));
	test('mssql', async () => await verify('mssql'));
...
describe('getMany many-relation count filter with predicate', () => {
	test('pg', async () => await verify('pg'));
	test('pglite', async () => await verify('pglite'));
	test('oracle', async () => await verify('oracle'));
	test('mssql', async () => await verify('mssql'));
	...
	async function verify(dbName) {
		const { db } = getDb(dbName);
		const rows = await db.order.getMany({
			where: x => x.lines.count(line => line.product.contains('guitar')).eq(1),
			orderBy: 'id'
		});
...
describe('column to column filter', () => {
	test('pg', async () => await verify('pg'));
	test('pglite', async () => await verify('pglite'));
	test('oracle', async () => await verify('oracle'));
	test('mssql', async () => await verify('mssql'));
...
describe('column to column contains filter', () => {
	test('pg', async () => await verify('pg'));
	test('pglite', async () => await verify('pglite'));
	test('oracle', async () => await verify('oracle'));
	test('mssql', async () => await verify('mssql'));
...
describe('column to column startsWith filter', () => {
	test('pg', async () => await verify('pg'));
	test('pglite', async () => await verify('pglite'));
	test('oracle', async () => await verify('oracle'));
	test('mssql', async () => await verify('mssql'));
	...
	async function verify(dbName) {
		const { db } = getDb(dbName);
		const rows = await db.order.getMany({
			where: x => x.deliveryAddress.name.startsWith(x.customer.name),
			orderBy: 'id'
		});
...
describe('column to column endsWith filter', () => {
	test('pg', async () => await verify('pg'));
	test('pglite', async () => await verify('pglite'));
	test('oracle', async () => await verify('oracle'));
	test('mssql', async () => await verify('mssql'));
	...
	async function verify(dbName) {
		const { db } = getDb(dbName);
		const rows = await db.order.getMany({
			where: x => x.deliveryAddress.name.endsWith(x.customer.name),
			orderBy: 'id'
		});
