...
connectViaPool.createSharedDbWorkerClient = require('./client/sharedDbWorkerClient');
connectViaPool.createSharedDbWorkerHandler = require('./client/sharedDbWorkerHandler');
