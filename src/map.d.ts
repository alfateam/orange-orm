...
type DbConnectable<T> = {
	...
	mariadb(connectionString: string, options?: PoolOptions<SchemaFromMappedDb<T>>): DBClient<SchemaFromMappedDb<T>>;
...
interface Connectors<M extends Record<string, any> = any> {
	...
	mysql(connectionString: string, options?: PoolOptions<M>): Pool;
	mariadb(connectionString: string, options?: PoolOptions<M>): Pool;
