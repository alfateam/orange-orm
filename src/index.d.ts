...
declare namespace r {
    ...
    function createPatch(original: any, modified: any): JsonPatch;
    function createSqliteOPFSWorker(options?: Omit<SqliteOPFSPoolOptions, 'createWorker'> & { connectionString?: string; createWorker?: undefined }): Worker;
    function createSqliteOPFSWorker(options: SqliteOPFSPoolOptions & { connectionString?: string }): Worker | MessagePort;
    function connectSqliteOPFSWorker(worker: Worker | MessagePort): MessagePort;
