...
when(c)
    ...
    .it('should set rdb.encodeBoolean').assertEqual(c.encodeBoolean, c.domain.rdb.encodeBoolean)
    ...
    .it('should set multipleStatements true').assertEqual(true, c.domain.rdb.multipleStatements)
